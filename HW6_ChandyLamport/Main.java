...
public class Main {
	...
	public static void main(String args[]) {
		...
		Buffer channelP32 = new Buffer("P32"); // source destination
		Buffer channelP12 = new Buffer("P12"); // source Dest
		...
		Algorithm algo1 = new Algorithm(processor1, processor2, processor3, 1);
		Algorithm algo2 = new Algorithm(processor1, processor2, processor3, 2);
		Algorithm algo3 = new Algorithm(processor1, processor2, processor3, 3);
